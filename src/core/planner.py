...
from src.chains.itenary_chains import generate_itineary
...
class TravelPlanner:
    ...
    def set_city(self,city:str):
        try:
            ...
            logger.error(f"error setting city: {str(e)}")
            raise CustomException("Failed to set city" , error_detail=e)
    
    def set_interests(self,interests_str:list[str]):
        try:
